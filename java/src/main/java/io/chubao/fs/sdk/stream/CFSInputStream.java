...
public class CFSInputStream extends InputStream {
    ...
    public int available() throws IOException {
        return (int) (cfsFile.getFileSize() - cfsFile.getPosition());
    }
    ...
    public void seek(long pos) throws IOException {
        if (pos > cfsFile.getFileSize()) {
            throw new EOFException("The pos [" + pos + "] is more than file size, " + cfsFile.getFileSize());
        }
