...
func (mf *MetadataFsm) Apply(command []byte, index uint64) (resp interface{}, err error) {
	...
	switch cmd.Op {
	case opSyncDeleteDataNode, opSyncDeleteMetaNode, opSyncDelete, opSyncDeleteVol, opSyncDeleteDataPartition, opSyncDeleteMetaPartition, opSyncDeleteEcPartition,
